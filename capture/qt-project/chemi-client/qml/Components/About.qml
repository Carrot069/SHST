...
Rectangle {
    ...
    WzButton {
        ...
        imageVisible: true
        imageSourceNormal: "qrc:/images/button_cancel_606060.svg"
        imageSourceHot: "qrc:/images/button_cancel_000000.svg"
        image.sourceSize.width: 20
        image.sourceSize.height: 20
        imageHot.sourceSize.width: 20
        imageHot.sourceSize.height: 20
        radius: 15
        onClicked: {
            root.opacity = 0
        }
