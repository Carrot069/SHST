            ...
            Item {
                ...
                Item {
                    ...
                    WzSpinBox {
                        ...
                        from: 2
                        to: 99
                        isShowButton: WzUtils.isPC()
                        editable: WzUtils.isPC()
                        buttonColor: "#535353"
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            tumblersPopup.value = spinBoxGrayAccumulate.value
                            tumblersPopup.parent = parent
                            tumblersPopup.y = (-tumblersPopup.implicitHeight / window.scale) - 65 * window.scale
                            tumblersPopup.x = (parent.width - tumblersPopup.implicitWidth / window.scale) / 2
                            tumblersPopup.open()
                        }
                    }
                }
            ...
            Item {
                ...
                Item {
                    ...
                    MouseArea {
                        ...
                        visible: !WzUtils.isPC()
                        onClicked: {
                            tumblersPopup.value = spinBoxTimeAccumulateCount.value
                            tumblersPopup.parent = parent
                            tumblersPopup.y = (-tumblersPopup.implicitHeight / window.scale) - 65 * window.scale
                            tumblersPopup.x = (parent.width - tumblersPopup.implicitWidth / window.scale) / 2
                            tumblersPopup.open()
    ...
    WzTumblers2Popup {
        ...
        onValueChanged: {
            if (tabBar.currentIndex === 0)
                spinBoxGrayAccumulate.value = value
            else if (tabBar.currentIndex === 1)
                spinBoxTimeAccumulateCount.value = value
        }
    }
}
