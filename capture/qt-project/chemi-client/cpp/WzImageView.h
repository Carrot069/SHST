...
public:
    ...
    Q_PROPERTY(QVariant colorTable READ getColorTable WRITE setColorTable);
    Q_PROPERTY(bool showColorBar READ getShowColorBar WRITE setShowColorBar NOTIFY showColorBarChanged);
    Q_PROPERTY(bool colorTableInvert READ getColorTableInvert WRITE setColorTableInvert)
    Q_PROPERTY(int grayLow READ getGrayLow WRITE setGrayLow);
    Q_PROPERTY(int grayHigh READ getGrayHigh WRITE setGrayHigh);
