...
int WzAbstractCamera::getFrameCount()
{
    return m_frameCount;
}
...
QString WzAbstractCamera::mkdirImagePath() {
    return mkdirImagePath(QDate::currentDate());
}

QString WzAbstractCamera::mkdirImagePath(const QDate &date)
{
