...
public:
    ...
    virtual int getMarkerImage(uint16_t** buffer);
...
signals:
    ...
    void cameraCount(WzAbstractCamera *sender, const int count);
...
private:
    ...
    int m_previewExposureMs = 1;
    uint16_t* m_fakePreviewImage = nullptr;
};
