...
Item {
    ...
    WzSpinBox {
        ...
        onValueChanged: {
            ...
            dbService.saveValueToDisk("chemi/previewExposureMs", adminParams.chemi.previewExposureMs)
    ...
    Component.onCompleted: {
        exposureTime.value = dbService.readValueFromDisk("chemi/previewExposureMs")
    }
