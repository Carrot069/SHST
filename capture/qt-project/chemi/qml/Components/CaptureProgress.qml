...
Item {
    ...
    Text {
        ...
        color: WzUtils.isMini() ? "white" : "#7f7f7f"
        font.pixelSize: 20
        font.family: "Arial"
        text: root.progress + "%"
        visible: isProgress
    ...
    WzButton {
        ...
        imageVisible: true
        imageSourceNormal: WzUtils.isMini() ? "qrc:/images/button_cancel_ffffff.svg" : "qrc:/images/button_cancel_8c8c8c.svg"
    ...
    WzBusyIndicator {
        ...
        color: WzUtils.isMini() ? fontColor : "black"
